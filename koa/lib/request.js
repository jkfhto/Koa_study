...
const fresh = require('fresh');//使用请求和响应标头检查响应的新鲜度 缓存协商
...
/**
 * 主要是对原生的 http 模块的 requets 对象进行封装, 其实就是对 request 对象某些属性或方法通过重写 getter/setter 函数进行代理
 * Prototype.
 */
...
module.exports = {
  ...
  /**
   * 获取解析的查询字符串, 当没有查询字符串时，返回一个空对象。请注意，此 getter不支持嵌套解析
  ...
  /**
   * 返回请求远程地址。 当 app.proxy 是 true 时支持 X-Forwarded-Proto
